...
func (relationDatacenterL) LoadDatacenter(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRelationDatacenter interface{}, mods queries.Applicator) error {
	...
	if singular {
		object = maybeRelationDatacenter.(*RelationDatacenter)
	} else {
		slice = *maybeRelationDatacenter.(*[]*RelationDatacenter)
	}
...
func RelationDatacenters(mods ...qm.QueryMod) relationDatacenterQuery {
	mods = append(mods, qm.From("\"relation_datacenters\""))
	q := NewQuery(mods...)
...
func FindRelationDatacenter(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*RelationDatacenter, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"relation_datacenters\" where \"id\"=$1", sel,
	)
...
func (o *RelationDatacenter) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
...
func (q relationDatacenterQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
...
func (o RelationDatacenterSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if len(o) == 0 {
		return 0, nil
	}
...
func RelationDatacenterExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"relation_datacenters\" where \"id\"=$1 limit 1)"
